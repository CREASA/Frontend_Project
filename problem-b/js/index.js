...
/* Create and log a variable `twelveString` that is the result of passing "8" 
  ...
  // The function "coerce" operators turning the string "8" to the number 8 and adds 4 into it, so we get the value of 12.
...
function getHighCard(cards) {
  let highCard = null;
  for (let card of cards) {
    if (highCard === null || card.rank > highCard.rank) {
      highCard = card;
    }
  }
  return highCard;
