...
function huskiesLost(game) {
  return game.home === "UW" ? game.home_score < game.opponent_score : game.home_score > game.opponent_score;
  }
...
const fumbledGames = huskyGames2016.filter(function(game) {
...
const lostGamesWithFumbles = huskyGames2016.filter(fumbledAndLostFilter);
console.log(lostGamesWithFumbles);
...
const scoreDifference = huskyGames2016.reduce(function(total, game) {
